      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center opacity-0 animate-fade-in" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
            ...
            <h3 className="font-heading text-xl font-semibold mb-2 border-2 border-primary/20 rounded-lg px-4 py-2 bg-primary/5">Качество и надежность</h3>
          ...
          <div className="text-center opacity-0 animate-fade-in" style={{animationDelay: '0.4s', animationFillMode: 'forwards'}}>
            ...
            <h3 className="font-heading text-xl font-semibold mb-2 border-2 border-primary/20 rounded-lg px-4 py-2 bg-primary/5">Быстрая выдача</h3>
          ...
          <div className="text-center opacity-0 animate-fade-in" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
            ...
            <h3 className="font-heading text-xl font-semibold mb-2 border-2 border-primary/20 rounded-lg px-4 py-2 bg-primary/5">Доставка по области</h3>
