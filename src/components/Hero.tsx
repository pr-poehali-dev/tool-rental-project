  ...
  return (
    <section className="relative py-20 animate-fade-in overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-xl text-white mb-8 max-w-3xl mx-auto drop-shadow-md">Профессиональный прокат качественного оборудования в городе Кандалакша. Всё необходимое для ваших проектов.</p>
